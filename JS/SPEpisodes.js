...
const EPISODES = [
    ...
    [true,189,13,8,'Dead Celebrities',
...
function generateModalFrame() {
    ...
    for (let i=0;i<EPISODES.length;i++) {
        ...
        if (EPISODES[i][22]) {
            let kDeathRowNode = document.createElement('div');
            let kDeathRowNodeClass = document.createAttribute('class');
            kDeathRowNodeClass.value = 'row';
            kDeathRowNode.setAttributeNode(kDeathRowNodeClass);
            div6Node.appendChild(kDeathRowNode);

            let kDeathColNode = document.createElement('div');
            let kDeathColNodeClass = document.createAttribute('class');
            kDeathColNodeClass.value = 'col';
            kDeathColNode.setAttributeNode(kDeathColNodeClass);
            kDeathRowNode.appendChild(kDeathColNode);

            let kDeathPNode = document.createElement('p');
            let kDeathTextNode = document.createTextNode('Kenny Death: '+EPISODES[i][22]);
            kDeathColNode.appendChild(kDeathPNode);
            kDeathPNode.appendChild(kDeathTextNode);
        }
