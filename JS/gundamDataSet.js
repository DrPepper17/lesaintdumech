...
const projects = [
    //Ad Stella (Mercury)
    ['Aerial [HG]',['Aerial'],'HG',true,false,false,'Mercury','D',"2023-05-30",2.25,false],
    ...
    ['Azrael',['Dilanza, Guel\'s'],'HG',false,false,false,'Mercury','E',"2023-01",12.14,false],
    ['Adriel',['LFrith'],'HG',false,false,false,'Mercury','B'],
    ['LFrith [HG]',['LFrith'],'HG',false,false,false,'Mercury','D',"2023-04",2.33,false],
    ...
    ['PB Deathscythe Hell (TV Version',['Deathscythe Hell'],'HG',false,true,false,'Wing','A'],
    ...
    ['PB Geminass 01 [HG]',['Geminass 01','Geminass Assault Mobility Booster Expansion Pack'],'HG',true,true,false,'Wing','E',"2022-12",6.5,false],
    ['Major Tom',['Geminass 01'],'SD',false,false,false,'Wing','E',"2021-12",5.15,false],
    ['Guerilla Arms',['Heavy Arms'],'MG',false,false,false,'Wing','E',"2021-04",60.07,false],
    ['Phoebe',['Maganac Corps'],'SD',false,false,false,'Wing','D',"2022-04",8.42,false],
    ['Isaac',['Proto-Zero'],'SD',false,false,false,'Wing','E',"2023-02",14.14,false],
    ['Jericho',['Proto-Zero'],'HG',false,false,false,'Wing','E',"2023-01",12.79,false],
    ['King David',['Proto-Zero'],'MG',false,false,false,'Wing','E',"2023-03",52.11,true],
    ['Metal Zero',['Proto-Zero'],'SD',false,false,false,'Wing','E',"2023-01",14.19,false],
    ['Proto-Zero [SD]',['Proto-Zero'],'SD',true,false,false,'Wing','E',"2021-12",1.67,false],
    ['Napoleon',['Tallgeese','Ceramic Horse'],'MG',false,false,false,'Wing','B'],
    ['St Dominic',['Tallgeese'],'RG',false,false,false,'Wing','E',"2021-12",19,false],
    ['PB Fl\u00FCgel Sparkel',['Tallgeese Fl\u00FCgel'],'MG',false,true,false,'Wing','B'],
    ['PB Tallgeese Fl\u00FCgel [MG]',['Tallgeese Fl\u00FCgel'],'MG',true,true,false,'Wing','D',"2022-05",20.17,false],
    ['Wild Wing',['Wing Gundam'],'MG',false,false,false,'Wing','E',"2021-07",60.48,true],
    ['Wing Gundam [RG]',['Wing Gundam'],'RG',true,false,false,'Wing','E',"2021-07",12.59,false],
    ['PB Clear Wing Zero [RG]',['Wing Zero'],'RG',true,true,false,'Wing','E',"2021-11",6.15,false],
    ...
    ['Gold Dust Woman',['Wing Zero'],'SD',false,false,false,'Wing','E',"2021-09",8.37,false],
    ...
    ['Wing Zero EW KA [MG]',['Wing Zero','GFFMC Wings For MG Wing Zero'],'MG',true,false,false,'Wing','C',"2022-06",10.83,false],
    ...
    //After War (X)
    ['Gaebora',['Airmaster'],'SD',false,false,false,'X','E',"2021-10",5.51,false],
    ['Biohazard',['Double X'],'SD',false,false,false,'X','E',"2022-08",10,false],
    ['Charlie Daniels',['Double X'],'SD',false,false,false,'X','E',"2021-10",4.51,false],
    ['Corona Virus',['Double X'],'MG',false,false,false,'X','E',"2022-09",36.08,false],
    ['Double X [MG]',['Double X'],'MG',true,false,false,'X','E',"2022-09",7.58,false],
    ['Double X [HG]',['Double X'],'HG',true,false,false,'X','E',"2022-08",2,false],
    ['Guapo',['Leopard'],'SD',false,false,false,'X','E',"2021-10",6.2,false],
    ['Iron Maiden',['X Gundam'],'SD',false,false,false,'X','E',"2021-10",4.83,false],

    //Anno Domini (00)
    ['Gundam Umlaut \xD6\xD6',['00 Gundam'],'SD',false,false,false,'00','E',"2021-06",10.83,false],
    ['Metatron',['00 Raiser'],'SD',false,false,false,'00','B'],
    ['PB Trans-Am Clear 00 Raiser [RG]',['00 Gundam Raiser'],'RG',true,true,false,'00','E',"2021-12",12.67,false],
    ['Silver n GOld',['00 Gundam QAN[T]'],'RG',false,false,false,'00','B'],
    ['Thunder QAN[T]',['00 Gundam QAN[T]'],'SD',false,false,false,'00','E',"2021-06",11.68,true],
    ['PB Trans-Am Clear 00 QAN[T] [RG]',['00 Gundam QAN[T]'],'RG',true,true,false,'00','E',"2022-01",8.33,false],
    ['Nena',['Exia'],'SD',false,false,false,'00','D',"2021-12",4.95,false],
    ['PB Trans-Am Clear Exia [RG]',['Exia'],'RG',true,true,false,'00','E',"2021-12",6.58,false],
    ['PB Harute (Final Battle Version) [HG]',['Harute'],'HG',true,true,false,'00','E',"2022-03",5.75,false],
    ['Virtue/Nadlee [MG]',['Virtue','Nadlee'],'MG',true,false,false,'00','E',"2022-02",20.08,true],
    ['PB Zabanya (Final Battle Version) [HG]',['Zabanya'],'HG',true,true,false,'00','E',"2022-03",3,false],

    //Correct Century (Turn A)
    ['John Wayne',['Turn-A'],'SD',false,false,false,'TurnA','E',"2021-09",6.62,false],

    //Cosmic Century (Seed)
    ['Gundam Fluorescent',['Aegis'],'SD',false,false,false,'Seed','E',"2021-06",9.94,false],
    ['Bald Eagle',['Astray Blue Frame'],'MG',false,false,false,'Seed','B'],
    ['Raphael',['Astray Gold Frame'],'SD',false,false,false,'Seed','B'],
    ['Oowashi Akatsuki [HG]',['Akatsuki, Oowsahi'],'HG',true,false,false,'Seed','E',"2021-12",2.67,false],
    ['Rising Sun',['Akatsuki, Oowashi'],'HG',false,false,false,'Seed','E',"2021-11",17.28,false],
    ['King Mars',['Akatsuki, Shiranui'],'HG',false,false,false,'Seed','D',"2022-05",13.67,false],
    ['Archangel',['Archangel','Archangel'],'Ship',false,false,false,'Seed','E',"2021-08",76.63,false],
    ['Dominion',['Archangel'],'Ship',false,false,false,'Seed','E',"2021-09",21.87,false],
    ...
    ['PB Armageddon',['Dagger L','Dagger L','Dagger Expansion Pack'],'HG',false,true,false,'Seed','E',"2022-03",28.5,false],
    ['King Leir',['Dagger L'],'HG',false,false,false,'Seed','E',"2021-06",14.91,false],
    ['Samus',['Dagger L'],'HG',false,false,false,'Seed','B'],
    ['Charizard',['Destiny'],'MG',false,false,false,'Seed','B'],
    ['Charizard X',['Destiny'],'SD',false,false,false,'Seed','E',"2021-10",8.13,false],
    ...
    ['PB Eclipse [MG]',['Eclipse','Eclipse Maneuver Striker'],'MG',true,true,false,'Seed','E',"2022-02",17.75,false],
    ['Eternal',['Eternal'],'Ship',false,false,false,'Seed','E',"2021-08",24.1,false],
    ['Anthem',['Freedom'],'MG',false,false,false,'Seed','E',"2022-05",73.16,true],
    ['Freedom [MGSD]',['Freedom'],'MGSD',true,false,false,'Seed','C',"2023-03",8.5,false],
    ['Liberty',['Freedom'],'SD',false,false,false,'Seed','E',"2022-04",18,false],
    ['Old Glory',['Freedom'],'MGSD',false,false,false,'Seed','C',"2023-05",15.25,false],
    ['Billy Blue Jay',['Ginn'],'MG',false,false,false,'Seed','B'],
    ['PB Destiny Impulse (Regenes) [MG]',['Impulse, Destiny'],'Seed','MG',true,true,false,'C',"2023-05",6.5,false],
    ['PB Destiny Impulse [RG]',['Impulse, Destiny'],'RG',true,true,false,'Seed','B'],
    ['Don\'t Tread On Ye',['Justice'],'MG',false,false,false,'Seed','E',"2022-06",51.75,true],
    ['AntiJustice',['Justice'],'SD',false,false,false,'Seed','B'],
    ['Pacifist',['Justice'],'SD',false,false,false,'Seed','E',"2022-04",14.58,false],
    ['PB Clear \u221e Justice [RG]',['Infinite Justice'],'RG',true,true,false,'Seed','E',"2021-11",4.93,false],
    ['Oppression',['Infinite Justice'],'MG',false,false,false,'Seed','B'],
    ['Zoroaster',['Legend'],'FM',false,false,false,'Seed','B'],
    ['PB Meteors',['Meteor','Meteor I','Meteor II','Freedom','Infinite Justice'],'HG',false,true,false,'Seed','B'],
    ['Union Jack',['Providence'],'MG',false,false,false,'Seed','A'],
    ['Raider [FM]',['Raider'],'FM',true,false,false,'Seed','D',"2023-01",9.75,false],
    ['Rodan',['Raider'],'FM',false,false,false,'Seed','A'],
    ['Blue Angels',['Skygrasper','Skygrasper','Skygrasper'],'RG',false,false,false,'Seed','E',"2022-12",22,true],
    ['Skygrasper [PG]',['Skygrasper'],'PG',true,false,false,'Seed','E',"2022-10",6,false],
    ['Skygrasper [RG]',['Skygrasper','Skygrasper','Skygrasper'],'RG',false,false,false,'Seed','E',"2022-09",10,false],
    ['PB Lightning Strike',['Strike','Lightning Striker','Sword Launcher Striker Pack'],'MG',false,true,false,'Seed','B'],
    ['Metal Strike',['Strike'],'SD',false,false,false,'Seed','B'],
    ['Strike Gundam [PG]',['Strike'],'PG',true,false,false,'Seed','C',"2023-05",11.67,true],
    ['PB Perfect Strike [RG]',['Strike, Perfect'],'RG',true,true,false,'Seed','E',"2022-03",12.33,false],
    ['S.A.T.O.',['Strike, Perfect'],'SD',false,false,false,'Seed','D',"2022-01",14.85,false],
    ['PB PB Strike Daggers [HG]',['Strike Dagger','Strike Dagger','Strike Dagger'],'HG',false,true,false,'Seed','D',"2023-03",22,false],
    ['AntiFreedom',['Strike-Freedom'],'SD',false,false,false,'Seed','B'],
    ['Servitude',['Strike-Freedom'],'MG',false,false,false,'Seed','B'],
    ['Strike-Freedom Full Burst [MG]',['Strike-Freedom'],'MG',true,false,false,'Seed','E',"2021-07",18.42,false],
    ['Strike-Freedom MGEX',['Strike-Freedom'],'MG',true,false,true,'Seed','C',"2023-03",14.25,false],
    ['PB Strike-Freedom (Deactive) [RG]',['Strike-Freedom'],'RG',true,true,false,'Seed','D',"2023-03",4.75,false],
    ['Battra',['Strike Noir'],'MG',false,false,false,'Seed','B'],
    ['Strike Noir [SD]',['Strike Noir'],'SD',true,false,false,'Seed','D',"2021-09",2.233,false],
    ['Strike Verde',['Strike Noir'],'SD',false,false,false,'Seed','D',"2021-12",8,false],
    ['Oberon',['Windam'],'HG',false,false,false,'Seed','E',"2022-03",20.25,false],
    ['PB Slash Zaku Phantom (Yzak Jule Custom) [MG]',['Zaku Phantom, Slash'],'MG',true,true,false,'Seed','C',"2023-04",3.33,false],
    
    //Future Century (G Gundam)
    ['PB Burning Gundam [RG]',['Burning Gundam','Burning Gundam Expansion Pass','Burning Gundam LED lights'],'RG',true,true,false,'G','C',"2022-09",15.5,true],
    ['Michael',['Burning Gundam'],'SD',false,false,false,'G','B'],
    ['Furcas',['Dark Army'],'HG',false,false,false,'G','B'],
    ['Malphas',['Dark Army'],'HG',false,false,false,'G','E',"2022-09",5.83,false],
    ...
    ['Dark Gundam [SD]',['Dark Gundam'],'SD',true,false,false,'G','D',"2022-08",1.75,false],
    ['Paimon',['Dark Gundam'],'SD',false,false,false,'G','B'],
    ['PB Gundam Rose [HG]',['Rose Gundam'],'HG',true,true,false,'G','A'],
    ['Le Roi Soleil',['Rose Gundam'],'HG',false,false,false,'G','E',"2022-08",4.17,false],
    ['Gabriel',['Shining Gundam'],'SD',false,false,false,'G','B'],
    ['Red Baron',['Spiegel, Gundam'],'MG',false,false,false,'G','E',"2021-05",72.07,true],
    ['Red Baron 2',['Spiegel, Gundam'],'MG',false,false,false,'G','A'],

    //Post Disaster (IBO)
    ['Thorn',['Barbatos'],'MG',false,false,false,'IBO','B'],
    ['War Pig',['Barbatos'],'SD',false,false,false,'IBO','E',"2021-12",4.15,false],
    ['Deep Purple',['Barbatos Lupus'],'SD',false,false,false,'IBO','D',"2021-12",4.36,false],
    ['Sealiah',['Barbatos Lupus'],'HG',false,false,false,'IBO','D',"2023-02",12.51,false],
    ['Nephilim',['Barbatos Lupus Rex'],'HG',false,false,false,'IBO','E',"2021-06",23.11,false],
    ['Queen Venus',['Gremory'],'HG',false,false,false,'IBO','B'],
    ['Vine',['Hashmal'],'HG',false,false,false,'IBO','D',"2023-01",19.64,false],
    ['\u00dcbermensch',['Vidar'],'FM',false,false,false,'IBO','B'],

    //Universal Century
    ['DewDrop',['Acguy'],'HG',false,false,false,'UC','C',"2023-05-29",2.75,false],
    ['Fantomas',['Banshee Norn'],'SD',false,false,false,'UC','E',"2021-06",15.02,true],
    ['King Uranus',['Banshee Norn'],'RG',false,false,false,'UC','B'],
    ['Gundam ARRRgent',['Crossbone X-1'],'SD',false,false,false,'UC','E',"2021-06",14.09,false],
    ['Crossbone [RG]',['Crossbone X-1'],'RG',true,false,false,'UC','D',"2022-05",9.08,false],
    ['King Neptune',['Crossbone X-1'],'RG',false,false,false,'UC','B'],
    ['Jackie-O',['Delta Plus'],'SD',false,false,false,'UC','E',"2022-01",11.17,false],
    ['Interstellar',['Dom Test Type'],'HG',false,false,false,'UC','E',"2022-08",14.07,false],
    ['Rhea',['RX-75 Guntank'],'SD',false,false,false,'UC','B'],
    ['Theia',['Kshatriya'],'SD',false,false,false,'UC','D',"2022-12",12.03,false],
    ['Der Kommissar',['Lightning Gundam'],'SD',false,false,false,'UC','E',"2021-12",4.05,false],
    ['Nachtigall',['Nightingale'],'SD',false,false,false,'UC','B'],
    ['Mnemosyne',['Neue Ziuel'],'SD',false,false,false,'UC','B'],
    ['Gundam \u03C0',['Nu Gundam'],'SD',false,false,false,'UC','E',"2021-06",15.66,false],   //pi gundam
    ...
    ['Titan',['Phenex'],'SD',false,false,false,'UC','E',"2021-11",6.63,false],
    ['LunchTime Solutions',['RX-78-2'],'RG',false,false,false,'UC','B'],
    ['Starman',['Sazabi'],'SD',false,false,false,'UC','D',"2021-12",5.03,false],
    ['Ziggy',['Sazabi'],'SD',false,false,false,'UC','D',"2022-03",5.75,false],
    ['Dynamo',['Sinanju'],'MG',false,false,false,'UC','B'],
    ['Stardust',['Sinanju'],'SD',false,false,false,'UC','D',"2021-12",4.56,false],
    ['PB Shin Musha [MG]',['Shin Musha Gundam'],'MG',true,true,false,'UC','E',"2022-08",10.58,false],
    ['Blue Monday',['Sisquiede'],'SD',false,false,false,'UC','D',"2022-01",6.76,false],
    ['Rocket Man',['Xi Gundam'],'SD',false,false,false,'UC','D',"2022-01",6.5,false],
    ['MK Ultra',['Zaku II'],'RG',false,false,false,'UC','B'],
    ['Zeong [RG]',['Zeong'],'RG',true,false,false,'UC','E',"2021-08",8.25,false],
    ['Starrider',['Zeta Gundam'],'SD',false,false,false,'UC','E',"2021-09",6.83,false],
    ['Zeta [MG]',['Zeta Gundam'],'MG',true,false,false,'UC','C',"2023-04",8,false],

    //Regild Century (Reconguista)


    //Build Divers (BD)
    ['PB Trans-Am Clear 00 Diver [HG]',['00 Gundam Diver'],'HG',true,true,false,'BD','E',"2022-01",2.75,false],
    ...
    ['Constellation',['Strike Full Package'],'RG',false,false,false,'BD','E',"2021-11",37.52,true],
    ['Moonage Daydream',['Strike Full Package'],'SD',false,false,false,'BD','E',"2021-11",7.27,false],
    ...
    ['Oceanus',['Altron, Zhang He'],'SD',false,false,false,'Heroes','D',"2022-04",5.42,false],
    ...
    ['Azalea',['Delta, Sasuki'],'SD',false,false,false,'Heroes','E',"2021-10",6.5,false],
    ['Sasuki Delta [SD]',['Delta, Saskui'],'SD',true,false,false,'Heroes','E',"2021-09",1.5,false],
    ...
    ['Helios',['Freedom, Zhuge Liang'],'SD',false,false,false,'Heroes','D',"2022-03",9.25,false],
    ...
    ['Corona Australis',['Tallgeese, Xiahou Yuan'],'SD',false,false,false,'Heroes','D',"2022-04",7.75,false],
    ['Corona Borealis',['Tallgeese III, Xiahou Dun'],'SD',false,false,false,'Heroes','D',"2022-04",8.67,false],
    ['Coeus',['Unicorn, Long Zun Liu Vei'],'SD',false,false,false,'Heroes','A'],
    ['Bastiat',['Verde Buster, Sergeante'],'SD',false,false,false,'Heroes','E',"2021-10",8.3,false],
    ['Mighty Morphin Power Rangers',['Trinity Bike','Verde Buster, Sergeant DX','Verde Buster, Sergeant DX','Verde Buster Team Member','Verde Buster Team Member','Verde Buster Team Member','Verde Buster Team Member'],'SD',false,false,false,'Heroes','E',"2022-12",39.63,false],
    ['Eos',['Wing, Cao Cao'],'SD',false,false,false,'Heroes','A'],
    ['Tethys',['Wing Isei, Cao Cao'],'SD',false,false,false,'Heroes','D',"2022-04",8.67,false],
    ['Hyperion',['Wing Zero, Tian Ba Cao Cao'],'SD',false,false,false,'Heroes','B'],

    //Haro
    ['Haro Blue',['Haropla #05 Control Blue'],'Haro',false,false,false,'','D',"2023-04",2.55,false],
    ['Haro Cloud',['Haropla #12 Basic Green'],'Haro',false,false,false,'','D',"2023-04",3.27,false],
    ['Haro Green',['Haropla #12 Basic Green'],'Haro',false,false,false,'','D',"2023-04",2.75,false],
    ['Haro Lime',['Haropla #12 Basic Green'],'Haro',false,false,false,'','D',"2023-04",3.34,false],
    ['Haro Orange',['Haropla #11 Zakrello'],'Haro',false,false,false,'','D',"2023-04",4.08,false],
    ['Haro Pink',['Haropla #04 Momo Pink'],'Haro',false,false,false,'','D',"2023-04",2.68,false],
    ['Haro Purple',['Haropla #07 Ball Haro'],'Haro',false,false,false,'','D',"2023-04",2.65,false],
    ['Haro Red',['Haropla #02 Diva Red'],'Haro',false,false,false,'','E',"2023-04",2.78,false],
    
    //Car
    ['Hud Air',['Chevy Bel Air, 57'],'Car',false,false,false,'Chevy','E',"2021-05",23.05,true],
    ['Wilbur',['Volkswagen Beetle, 68'],'Car',false,false,false,'Volkswagen','E',"2022-11",27.08,true],
    
    //Pokemon
    ['Obelix',['Bulbasaur'],'Pokemon',false,false,false,'','B'],
    ['Asterix',['Charmander'],'Pokemon',false,false,false,'','D',"2023-03",3.85,false],
    ['Vercingetorix',['Charizard'],'Pokemon',false,false,false,'','D',"2023-03",5.99,false],
    ['Boudica',['Dragonite'],'Pokemon',false,false,false,'','D',"2023-03",3.47,false],
    ['Granfrog',['Greninja'],'Pokemon',false,false,false,'','E',"2021-11",5.68,false],
    ...
    ['Thor',['Gallantmon'],'Digimon',false,false,false,'','E',"2022-10",22.5,false],
    ['Jormungandr',['Imperialdramom'],'Digimon',false,false,false,'','A'],
    ['Nidhogg',['Machinedramon'],'Digimon',false,false,false,'','A'],
    ['Fenrir',['Metal Garurumon'],'Digimon',false,false,false,'','E',"2022-07",20.58,false],
    ['Ragnarok',['Omnimon'],'Digimon',false,false,false,'','E',"2022-07",19.65,false],
    ['Revelation',['Omnimon X'],'Digimon',false,false,false,'','A'],
    ['Fafnir',['War Greymon'],'Digimon',false,false,false,'','E',"2022-07",20.7,false],

    //Display
    ['Diurnum',['City Area, 30 Minute Mission'],'Display',false,false,false,'','E',"2022-01",9.67,false],
    ['Battlefield Earth',['Energy Ring Emitter'],'Display',false,false,false,'','A'],
    ['Kataluma',['Hangar Bay'],'Display',false,false,false,'','E',"2022-02",16.96,true],
    ['Stratle',['Maintenance Bay'],'Display',false,false,false,'','E',"2022-02",27.12,true],

    //Ship
    ['Libeccio',['Andromeda Black'],'Ship',false,false,false,'StarBlazer','E',"2022-09",4.42,false],
    ['Ostro',['Cosmo Falcon'],'Ship',false,false,false,'StarBlazer','E',"2022-07",6.33,false],
    ['Ponente',['Cosmo Zero'],'Ship',false,false,false,'StarBlazer','B'],

    //Transformer
    ['Wilbee',['Bumblebee'],'Transformer',false,false,false,'','E',"2022-11",9.33,false],
